...
caps.add(InputModule(signal_shape=(1,) + x_train.shape[1:4], trainable=False, init_diss_initializer='zeros'))
caps.add(diss)
caps.add(SqueezeRouting())
caps.add(NearestCompetition(use_for_loop=False))
caps.add(DissimilarityTransformation(probability_transformation='neg_softmax', name='lvq_capsule'))
