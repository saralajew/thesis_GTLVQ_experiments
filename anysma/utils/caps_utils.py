...
# implemented caps_utils_test, SplitModule and minor fixes
#
# SplitModule:
# - The use of a Module functions gives a better workaround (see the
#   adapted examples).
# - Splits always into a dict of two entries (Capsule specific behavior)
# caps_utils_test:
# - implemented the test environment
# - changed equal_shape to equal_int_shape and added a default behavior if
#   the tuples have different len
